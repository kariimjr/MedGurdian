...
📂 Project Structure
MedGurdian/
├── assets/                  # App images, icons, and model files (.tflite)
├── lib/                     # Flutter source code
│   ├── bloc/                # BLoC state management (Auth, Scan, Medicine)
│   ├── models/              # Data models (User, ScanResult, Medicine)
│   ├── services/            # Firebase, Gemini API, and TFLite helpers
│   └── screens/             # UI views (Home, Scan, Chat, Profile, Reminders)
├── doctor_portal/           # React + TypeScript Web Portal
│   ├── src/
│   │   ├── components/      # Verification, Chat, Action Plan modules
│   │   └── services/        # Firebase web integration
└── README.md
